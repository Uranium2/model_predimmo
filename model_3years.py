...
DATA_TRAIN = "./data/train/prediction_3years/"
SAVE_MODEL_NAME = "_model_predimmo_3years"
...
def training_classification_3years():
  def data_preprocessing():
    ...
    df1 = pd.read_csv(DATA_TRAIN + "2015_2018.csv", encoding="utf-8")
    df2 = pd.read_csv(DATA_TRAIN + "2016_2019.csv", encoding="utf-8")
